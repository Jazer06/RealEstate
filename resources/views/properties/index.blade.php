                ...
                <div class="card property-card h-100" onclick="window.location='{{ route('properties.show', $property->id) }}'">
                    <div class="card-img-container">
                        ...
                        <div class="card-footer-button"
                            ...
                            @else
                                <a href="{{ route('login') }}" class="favorite-icon text-muted" title="Войдите, чтобы добавить в избранное">
                                    <i class="bi bi-heart"></i>
                                </a>
                            @endauth
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="modal-property-title" style="padding-top:10px">
                                        <b>{{ $sliders->firstWhere('id', $property->slider_id)->title ?? $property->title }}</b>
                                    </p>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p class="card-text mb-2" style="padding-top:10px">
                                        ...
                                        @else
                                            @auth
                                                <form action="{{ route('favorites.addAndProfile', $property->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline-secondary" onclick="event.stopPropagation();">
                                                        Узнать цену
                                                    </button>
                                                </form>
                                            @else
                                                <a href="{{ route('login') }}" class="btn btn-outline-secondary" onclick="event.stopPropagation();">
                                                    Узнать цену
                                                </a>
                                            @endauth
                                        @endif
