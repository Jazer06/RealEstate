        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled ">
                    <li><a class="text-light" href="{{ route('home') }}">Главная</a></li>
                    <li><a class="text-light"href="{{ route('consultation') }}">Консультация</a></li>
                    <li><a class="text-light"href="{{ route('services.real_estate') }}">Услуги</a></li>
                    <li><a class="text-light" href="{{ route('contacts') }}">Контакты</a></li>
                    <li><a class="text-light"href="{{ route('privacy.policy') }}">Политика конфиденциальности</a></li>
                </ul>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    @auth
                    <li><a class="text-light" href="{{ route('profile') }}">Избранное</a></li>
                    <li><a class="text-light"href="{{ route('profile') }}">Профиль</a></li>
                    @endauth
                    @guest
                    <li><a class="text-light"href="{{ route('login') }}">Войти</a></li>
                    @endguest
                </ul>
            </div>
        </div>
